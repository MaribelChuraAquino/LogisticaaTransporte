	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<!-- /.box-header -->
				<form role="form" action="<?= base_url('customer/update_customer'); ?>" method="post"
					...
					<?php echo form_error('name', '<div class="error" style="color: red">', '</div>'); ?>
										...
										<div class="form-group">
											...
											<textarea class="form-control" name="address"
													  id="exampleInputPassword1"><?= htmlspecialchars($customer->address); ?></textarea>
											<span>
					...
					<?php echo form_error('city', '<div class="error" style="color: red">', '</div>'); ?>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="zip"
												   value="<?= htmlspecialchars($customer->zip); ?>"
												   id="exampleInputPassword1">
											<span>
					...
					<?php echo form_error('telephone', '<div class="error" style="color: red">', '</div>'); ?>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="mc"
												   value="<?= htmlspecialchars($customer->mc); ?>"
												   id="exampleInputPassword1">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea class="form-control" name="notes"
													  id="exampleInputPassword1"><?= htmlspecialchars($customer->notes); ?></textarea>
										</div>
									</div>
								</div>
							</div>

							<input type="hidden" value="<?= htmlspecialchars($customer->id); ?>" name="id">
							<!-- /.box-body -->
