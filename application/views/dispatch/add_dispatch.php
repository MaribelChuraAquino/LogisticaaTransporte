...
<section class="content-header">
	<h1>
		Envio | <a href="<?php echo base_url('dispatch/view_dispatch'); ?>">
			<button class="btn btn-info btn-sm">Ver Envio</button>
		</a>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Agregar envio</h3>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<form role="form" action="<?= base_url('dispatch/store_dispatch'); ?>" method="post"
							...
							<div class="box-body">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="dispatch_id"
										   ...
										   value="<?= htmlspecialchars($dispatch_id); ?>" readonly>
								</div>
								<div class="form-group">
					...
					<?php echo form_error('last_name', '<div class="error" style="color: red">', '</div>'); ?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="phone"
										   value="<?= set_value('phone'); ?>" id="exampleInputPassword1"
