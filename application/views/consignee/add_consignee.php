		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Agregar destinatario</h3>
				</div>
				<div class="row">
				...
				<!-- /.box-header -->
				<form role="form" action="<?= base_url('consignee/store_consignee'); ?>" method="post"
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label for="exampleInputPassword1">ID del destinatario</label>
											<input type="text" class="form-control" name="consignee_id" readonly
												   value="<?= htmlspecialchars($consignee_id); ?>"
