...
<section class="content-header">
	<h1>
		Destinatario | <a href="<?php echo base_url('consignee/add_consignee'); ?>">
			<button class="btn btn-info btn-sm">Agregar destinatario</button>
		</a>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Ver destinatarios</h3>
				</div>
				<div class="row">
