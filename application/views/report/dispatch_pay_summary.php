		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Resumen de pago de envio</h3>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<form role="form" action="<?= base_url('report/show_dispatch_pay_summary'); ?>" method="post"
						  target="_blank"
								...
								<div class="form-group">
									...
									<select class="form-control select2" name="dispatch_id" required>
										...
										<?php foreach ($dispatches as $dispatch): ?>
											<option
												value="<?= htmlspecialchars($dispatch->id); ?>"><?= htmlspecialchars($dispatch->dispatch_id) . ' - ' . htmlspecialchars($dispatch->first_name) . ' ' . htmlspecialchars($dispatch->last_name); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								<div class="form-group">
