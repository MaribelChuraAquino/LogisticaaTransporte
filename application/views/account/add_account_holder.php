...
<section class="content-header">
	...
	<a href="<?php echo base_url('account/view_account_holder'); ?>">
			<button class="btn btn-info btn-sm">Ver titular de la cuenta</button>
		</a>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Agregar titular de cuenta</h3>
				</div>
				<div class="row">
