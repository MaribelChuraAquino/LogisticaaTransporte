...
-- Tiempo de generación: 04-12-2020 a las 11:15:13
...
--
-- Base de datos: `nwsktjeg_logistica`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_account_holder`
--
...
--
-- Volcado de datos para la tabla `tbl_account_holder`
--
...
--
-- Estructura de tabla para la tabla `tbl_consignee`
--
...
--
-- Volcado de datos para la tabla `tbl_consignee`
--
...
--
-- Estructura de tabla para la tabla `tbl_dispatch`
--
...
--
-- Volcado de datos para la tabla `tbl_dispatch`
--
...
--
-- Estructura de tabla para la tabla `tbl_load_entry`
--
...
--
-- Volcado de datos para la tabla `tbl_load_entry`
--
...
(1, 'tusolutionweb', 'tusolutionweb@gmail.com', 'Av índependencoa', '+8801976644447', 'image/9f08cf7d00592f9a77ad381b760d6eae.jpg', 'BDT', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_shippers`
--
...
--
-- Volcado de datos para la tabla `tbl_shippers`
--
...
--
-- Indices de la tabla `tbl_account_holder`
--
...
--
-- Indices de la tabla `tbl_consignee`
--
...
--
-- Indices de la tabla `tbl_dispatch`
--
...
--
-- Indices de la tabla `tbl_load_entry`
--
...
--
-- Indices de la tabla `tbl_shippers`
--
...
--
-- AUTO_INCREMENT de la tabla `tbl_account_holder`
--
ALTER TABLE `tbl_account_holder`
...
--
-- AUTO_INCREMENT de la tabla `tbl_consignee`
--
ALTER TABLE `tbl_consignee`
...
--
-- AUTO_INCREMENT de la tabla `tbl_dispatch`
--
ALTER TABLE `tbl_dispatch`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `tbl_load_entry`
--
ALTER TABLE `tbl_load_entry`
...
--
-- AUTO_INCREMENT de la tabla `tbl_shippers`
--
ALTER TABLE `tbl_shippers`
