    ...
    <body>
        ...
        <div class="container"> 
            ...
            <div class="row"> 
                ...
                <div class="row">
                    <div class="app_title"> 
                        <h1><img src="assets/img/icon.png" alt="logo"> Application installer</h1>
                    </div>
                    ...
                    <div class="app_footer"> 
                        <h3>Developed by synchrotheme</h3>
                    </div>
                </div>
                <?php 
                } 
                ...
                <div class="row">
                    <div class="app_title"> 
                        <h1><img src="assets/img/icon.png" alt="logo"> Invoicemaker installer</h1>
                    </div>
                    <div class="app_content">
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="alert alert-success">
                                    ...
                                    <br>
                                    <strong>Default username: admin <br>
